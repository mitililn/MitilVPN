...
def main():
    ...
    print("=" * 50)
    print("🚀 Полное обновление файлов на GitHub")
    print("=" * 50)
    ...
    print("\n" + "-" * 30)
    print("🧹 Удаляем старые файлы из репозитория (git rm -r *)...")

    # Удаляем все файлы из индекса и рабочего каталога
    os.system('git rm -r * --cached >nul 2>&1')
    os.system('git rm -r * >nul 2>&1')

    print("✅ Все старые файлы удалены (кроме .git)")
    ...
    if add_result == 0:
        ...
        commit_message = f"Full update - {timestamp}"
        ...
        if commit_result == 0:
            ...
            if push_result == 0:
                print("🎉 Репозиторий полностью обновлён на GitHub!")
            else:
